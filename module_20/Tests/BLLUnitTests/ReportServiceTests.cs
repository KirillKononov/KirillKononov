...
namespace Tests.BLLUnitTests
{
    public class ReportServiceTests
    {
        ...
        private static IEnumerable<LectureDTO> FindLectures()
        {
        ...
        private static async Task<LectureDTO> GetAsyncLecture()
        {
        ...
        private static IEnumerable<LectureDTO> FindLecturesValidationExceptionTest()
        {
            var lectures = new List<LectureDTO>();
            return lectures;
        }
        
        private static async Task<ProfessorDTO> GetAsyncProfessor()
        {
